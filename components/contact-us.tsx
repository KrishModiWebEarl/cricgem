      ...
      <footer className="bg-[#1b1253] text-white py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1">
              ...
              <div className="flex gap-4">
                <Youtube className="w-6 h-6 text-white/70 hover:text-white cursor-pointer" />
                <Instagram className="w-6 h-6 text-white/70 hover:text-white cursor-pointer" />
                <Facebook className="w-6 h-6 text-white/70 hover:text-white cursor-pointer" />
                <Play className="w-6 h-6 text-white/70 hover:text-white cursor-pointer" />
              </div>
            </div>
          ...
          <div className="border-t border-white/20 mt-8 pt-6 text-center">
            <p className="text-white/70">Copyright @ 2025 cricgem.in</p>
          </div>
        </div>
      </footer>
    </div>
